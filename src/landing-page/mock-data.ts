...
export const serviceSectionData = {
    ...
    subSection2: [
        ...
        {
            title: "Construction Quality Evaluation",
            link: "#"
        }
    ]
};
...
export const faqSectionData = {
    questions: [
        {
            qs: "Mauris ornare est nec ultrices rhoncus morbi faucibus consectetur ornare?",
            ans: "Vestibulum tempus et turpis at pretium. Nam cursus purus lacus, vitae pharetra quam ultricies eu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent non tincidunt risus. Sed aliquam fringilla diam, nec sollicitudin arcu aliquet efficitur. Etiam at justo vel augue ornare mollis sagittis non tortor. Duis eu libero elit. Vivamus risus felis, auctor id ullamcorper a, tincidunt sed magna."
        },
        {
            qs: "Nulla pulvinar a neque sed scelerisque phasellus porta odio dolor?",
            ans: "Vestibulum tempus et turpis at pretium. Nam cursus purus lacus, vitae pharetra quam ultricies eu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent non tincidunt risus. Sed aliquam fringilla diam, nec sollicitudin arcu aliquet efficitur. Etiam at justo vel augue ornare mollis sagittis non tortor. Duis eu libero elit. Vivamus risus felis, auctor id ullamcorper a, tincidunt sed magna."
        },
        {
            qs: "Vestibulum in feugiat metus aenean quis risus nibh etiam rhoncus egestas gravida?",
            ans: "Vestibulum tempus et turpis at pretium. Nam cursus purus lacus, vitae pharetra quam ultricies eu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent non tincidunt risus. Sed aliquam fringilla diam, nec sollicitudin arcu aliquet efficitur. Etiam at justo vel augue ornare mollis sagittis non tortor. Duis eu libero elit. Vivamus risus felis, auctor id ullamcorper a, tincidunt sed magna."
        },
        {
            qs: "Cras vel nunc sed massa tristique auctor vestibulum facilisis aliquet lectus vel congue?",
            ans: "Vestibulum tempus et turpis at pretium. Nam cursus purus lacus, vitae pharetra quam ultricies eu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent non tincidunt risus. Sed aliquam fringilla diam, nec sollicitudin arcu aliquet efficitur. Etiam at justo vel augue ornare mollis sagittis non tortor. Duis eu libero elit. Vivamus risus felis, auctor id ullamcorper a, tincidunt sed magna."
        },
        {
            qs: "Donec eget ante ipsum. Nam vestibulum maximus venenatis?",
            ans: "Vestibulum tempus et turpis at pretium. Nam cursus purus lacus, vitae pharetra quam ultricies eu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent non tincidunt risus. Sed aliquam fringilla diam, nec sollicitudin arcu aliquet efficitur. Etiam at justo vel augue ornare mollis sagittis non tortor. Duis eu libero elit. Vivamus risus felis, auctor id ullamcorper a, tincidunt sed magna."
        }
    ]
}
